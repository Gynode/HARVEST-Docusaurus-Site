...
export default {
  ...
  "baseUrl": "/HARVEST-Docusaurus-Site/",
  "onBrokenLinks": "throw",
  "onBrokenMarkdownLinks": "warn",
  "favicon": "img/harvest_favicon.png",
  "organizationName": "Gynode",
  "projectName": "HARVEST-Docusaurus-Site",
  "presets": [
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/Gynode/HARVEST-Docusaurus-Site/tree/main/"
        },
        "blog": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Advanced Light Systems (ALSYS).  Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
